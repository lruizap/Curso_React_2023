...
// El render solo espera un parámetro, por tanto tenemos que usar el react.fragment
// para renderizar más elementos.
root.render(
  <React.Fragment>

    <Button text={" Hola Illo"}></Button>
    <Button text={" Hola Illo 2"}></Button>
    <Button text={" Hola Illo 3"}></Button>
